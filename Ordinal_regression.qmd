...
ggplot(survey, aes(x = rating, fill = freq)) +
  ...
  facet_wrap(~freq) +
  theme_minimal() +
  labs(title = "Density of Ratings by Verb and Frequency",
...
**smooth terms** $f_k$ for $k = 1, ..., p$. For illustration, @eq-gam shows a linear additive model for a
continuous target variable with $p$ predictors.
