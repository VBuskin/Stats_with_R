...
::: {.callout-tip title="Handling data frames `tidyverse`-style" collapse="false"}
...
manipulation, transformation and visualisation. Installation instructions are provided in @sec-libraries.
