...
Please download the file `Paquot_Larsson_2020_data.xlsx` [@paquotDescriptiveStatisticsVisualization2020][^categorical_data-1] and store it in the same folder as your currently active R-script. Then run the code lines below:

[^categorical_data-1]: The original supplementary materials can be downloaded from the publisher's [website](https://link.springer.com/chapter/10.1007/978-3-030-46216-1_17) \[Last accessed April 28, 2024\].
