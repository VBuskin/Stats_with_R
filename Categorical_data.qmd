...
::: {#exr-cd-1}
Download the dataset `objects.xlsx` from [https://osf.io/j2mnx](https://osf.io/j2mnx). Load it into R and store it in a variable
`objects`. Make sure to load all the necessary libraries.
:::
