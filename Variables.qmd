...
::: {.callout-note title="Interval-scaled/continous" collapse="true"}
...
::: {.callout-note title="Ratio-scaled/continous" collapse="true"}
...
we'd like to explain as the **dependent** or **response** variable. A list of possible dependent variables is provided in the section on [Linguistic variables](Linguistic_variables.qmd)).
