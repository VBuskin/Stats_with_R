...
> unrelated prime. Unrelated primes were dissimilar in form and meaning
> from their corresponding targets; half of them were -*ed* inflected
> forms and half of them were -*er* derived words. The distributions of
> word-form frequency, lemma frequency, and length (in letters) of the
> three prime types were kept as similar as possible.
