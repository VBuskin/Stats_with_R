...
> in exchange for payment or course credits. \[...\] The experiment
> included 102 English monomorphemic verbs used as targets (e.g.,
> *print*). These were preceded by their -*ed* past-tense form (e.g.,
> *printed*) as the inflected prime, their -*er* nominalization (e.g.,
> *printer*) as the derived prime, or by an unrelated prime. Unrelated
> primes were dissimilar in form and meaning from their corresponding
> targets; half of them were -*ed* inflected forms and half of them were
> -*er* derived words.
