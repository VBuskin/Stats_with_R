...
2.  In RStudio, go to the `Files` pane (usually in the bottom-right
    corner) and navigate to the location of your script. Alternatively, you can click on the three dots `...` and use the file browser instead.
...
[-@lange_corpus_2020: 55] explain that specialised
