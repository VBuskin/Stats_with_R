...
## "I want a proper user interface": Using the `QuantedaApp`

This app provides a user-friendly GUI for `quanteda`. Installation and
usage instructions are available in this [GitHub
